export default {
  ...
  inventory: {
    ...
    exportCsvDisabled: "No rows to export",
  ...
  orders: {
    ...
    submittedOrdersEmpty:
      "No submitted orders yet. Place a restocking order from the Restocking tab.",
    totalOrders: "Total Orders",
  ...
  restocking: {
    title: "Restocking",
    description:
      "Set a budget and review recommended restocks from the demand forecast.",
    budgetCardTitle: "Available Budget",
    budgetLabel: "Budget",
    budgetHint:
      "Drag the slider or enter a value. Recommendations update automatically.",
    ...
    orderPlaced:
      "Order {orderNumber} placed · expected delivery {expectedDelivery}",
